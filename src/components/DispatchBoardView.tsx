  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex items-center bg-slate-950/60 backdrop-blur-md p-1 rounded-xl border border-white/10 text-xs">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg transition font-medium ${
                  activeSide === 'DUAL' ? 'bg-emerald-500/90 text-slate-950 font-bold shadow-lg shadow-emerald-500/20' : 'text-slate-400 hover:text-white'
                }`}
              >
                نمایش دوطرفه (احسان + دستغیب)
              </button>
              <button
                onClick={() => setActiveSide('EHSAN')}
                className={`px-3 py-1.5 rounded-lg transition font-medium ${
                  activeSide === 'EHSAN' ? 'bg-emerald-500/90 text-slate-950 font-bold shadow-lg shadow-emerald-500/20' : 'text-slate-400 hover:text-white'
                }`}
              >
                سمت پایانه احسان
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-lg transition font-medium ${
                  activeSide === 'DASTGHEYB' ? 'bg-emerald-500/90 text-slate-950 font-bold shadow-lg shadow-emerald-500/20' : 'text-slate-400 hover:text-white'
                }`}
              >
                سمت پایانه دستغیب
              </button>
      ...
      <div className={`grid gap-6 ${activeSide === 'DUAL' ? 'grid-cols-1 lg:grid-cols-2' : 'grid-cols-1'}`}>
        ...
        {/* Table 1: سمت پایانه احسان */}
        {(activeSide === 'DUAL' || activeSide === 'EHSAN') && (
          <div className="glass-panel rounded-3xl p-4 sm:p-5 shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between pb-3 border-b border-white/10 mb-3">
              ...
              <span className="text-xs text-slate-400 font-mono">
                {toPersianDigits(filteredEhsan.length)} ردیف نمایش داده شده
              </span>
            </div>
        ...
        {/* Table 2: سمت پایانه شهید دستغیب */}
        {(activeSide === 'DUAL' || activeSide === 'DASTGHEYB') && (
          <div className="glass-panel rounded-3xl p-4 sm:p-5 shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between pb-3 border-b border-white/10 mb-3">
              ...
              <span className="text-xs text-slate-400 font-mono">
                {toPersianDigits(filteredDastgheyb.length)} ردیف نمایش داده شده
              </span>
            </div>
