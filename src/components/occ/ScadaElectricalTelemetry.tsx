...
const SHIRAZ_LINE1_SUBSTATIONS: SubstationData[] = [
  { id: 'tps-1', code: 'TPS-01', nameFa: 'پست برق احسان (دپو غربی)', km: 0.0, voltageDC: 1535, feederAC20kV: 'ONLINE', currentAmps: 620, rectifierStatus: 'NOMINAL', temperatureC: 38 },
  { id: 'tps-2', code: 'TPS-02', nameFa: 'پست برق قصردشت / مطهری', km: 3.8, voltageDC: 1515, feederAC20kV: 'ONLINE', currentAmps: 580, rectifierStatus: 'NOMINAL', temperatureC: 36 },
  { id: 'tps-3', code: 'TPS-03', nameFa: 'پست برق نمازی', km: 8.2, voltageDC: 1495, feederAC20kV: 'ONLINE', currentAmps: 740, rectifierStatus: 'NOMINAL', temperatureC: 41 },
  { id: 'tps-4', code: 'TPS-04', nameFa: 'پست تقاطعی امام حسین / زندیه', km: 11.5, voltageDC: 1510, feederAC20kV: 'ONLINE', currentAmps: 810, rectifierStatus: 'NOMINAL', temperatureC: 42 },
  { id: 'tps-5', code: 'TPS-05', nameFa: 'پست برق ولی‌عصر', km: 14.8, voltageDC: 1525, feederAC20kV: 'ONLINE', currentAmps: 640, rectifierStatus: 'NOMINAL', temperatureC: 37 },
  { id: 'tps-6', code: 'TPS-06', nameFa: 'پست برق رازی / فضیلت', km: 17.6, voltageDC: 1530, feederAC20kV: 'ONLINE', currentAmps: 590, rectifierStatus: 'NOMINAL', temperatureC: 35 },
  { id: 'tps-7', code: 'TPS-07', nameFa: 'پست برق غدیر', km: 21.0, voltageDC: 1505, feederAC20kV: 'ONLINE', currentAmps: 630, rectifierStatus: 'NOMINAL', temperatureC: 39 },
  { id: 'tps-8', code: 'TPS-08', nameFa: 'پست برق شهید دستغیب (دپو شرقی)', km: 24.5, voltageDC: 1540, feederAC20kV: 'ONLINE', currentAmps: 690, rectifierStatus: 'NOMINAL', temperatureC: 36 },
];
...
export const ScadaElectricalTelemetry: React.FC = () => {
  ...
  return (
    <div className="glass-panel rounded-3xl p-4 sm:p-5 shadow-2xl space-y-5 animate-in fade-in duration-300">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-white/10">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-sm sm:text-base font-black text-white">
                پایش اسکادا و شبکه برق بالاسری OCS (SCADA 1500V DC Traction)
              </h3>
              <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 flex items-center gap-1">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400" />
                ۸ پست یکسوساز بالاسری فعال
              </span>
            </div>
            <p className="text-xs text-slate-400 mt-0.5">
              تغذیه شبکه برق بالاسری (OCS) با ولتاژ نامی ۱۵۰۰ ولت DC از طریق فیدرهای ۲۰ کیلوولت برق منطقه‌ای فارس
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 text-xs">
          <div className="px-3 py-1.5 rounded-xl glass-card-sub text-slate-300 flex items-center gap-2">
            <span className="text-slate-400">ولتاژ میانگین شبکه بالاسری (OCS):</span>
